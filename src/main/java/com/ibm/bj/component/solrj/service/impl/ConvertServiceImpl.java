...
import com.ibm.bj.component.solrj.service.IConvertService;
...
//    public static String doc2pdf(String docPath, String pdfLocation) {
        ...
        //java -jar /root/doc_view/jodconverter-2.2.2/lib/jodconverter-cli-2.2.2.jar  /root/doc_view/北京.docx /root/doc_view/北京.pdf
...
//    public static String pdf2swf(String pdfPath, String swfLocation){
        ...
        //pdf2swf -T 9 -s poly2bitmap -s zoom=150 -s flashversion=9 "/root/doc_view/北京.pdf" -o "/root/doc_view/北京.swf"
