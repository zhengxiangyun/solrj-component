 ...
 */
@Service
public class QueryFileServiceSolrMRImpl implements IQueryFileService {

    private Logger log = Logger.getLogger(QueryFileServiceSolrMRImpl.class);
    private CloudSolrServer cloudSolrServer;

    String  defaultCollection ="collection_mr"; //选择collection
...
//                System.out.println(doc.getFieldValue("last_modified"));
    ...
    public PageModel queryFiles(String keyword, String type, Integer currentPage, Integer pageSize) {
        ...
        ApplicationContext ctx =
                new ClassPathXmlApplicationContext("spring/solrj-spring-config.xml");
